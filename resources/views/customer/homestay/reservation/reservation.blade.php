...
<x-partials.page-hero
    ...
    subtitle="Review your pending homestay reservations and complete your payment."
    image="assets/customer/img/page-title-area/privacy.jpg"
    :crumbs="['Home' => '/', 'Reservation' => '', 'Unpaid' => '']"
/>
...
<section class="section-pad bg-cream-50">
    <div class="container-gd">
        <div class="grid gap-8 lg:grid-cols-3">
                ...
                <div class="space-y-6">
                    ...
                    @empty
                        <div class="card p-12 text-center">
                            <p class="font-display text-xl font-bold text-ink-950">No unpaid reservations</p>
                            <p class="mt-2 text-sm text-ink-500">You have no pending homestay payments.</p>
                        </div>
                    @endforelse
                </div>
                @if (count($order) > 0)
            ...
            <div>
                <x-partials.reservation-sidebar :email="$isiemail" base="reservation-homestay" active="unpaid" title="Status Booking HomeStay" />
            </div>
        </div>
    </div>
</section>
