...
<x-partials.page-hero
    ...
    subtitle="Transfer your payment to the GODEVI bank account below, then confirm your transfer."
    image="assets/customer/img/page-title-area/privacy.jpg"
    :crumbs="['Home' => '/', 'Payment Details' => '']"
/>
        ...
        <div class="card overflow-hidden">
            ...
            <div class="space-y-8 p-8 sm:p-10">
                <div class="text-center">
                    <p class="text-sm text-ink-500">Please transfer</p>
                    ...
                    <p class="mt-2 text-xs text-ink-400">for your purchase order</p>
                </div>

                <div class="rounded-2xl bg-cream-100 p-6">
                    <p class="text-center text-xs font-bold uppercase tracking-wider text-ink-400">Transfer to</p>
                    ...
                    @else
                        <p class="mt-2 text-center text-sm text-ink-500">Bank account not assigned yet.</p>
                    @endif
                </div>

                <a href="{{ url('payment-confirm/' . $order->id) }}" class="btn btn-primary w-full !py-4">
                    I've Transferred — Confirm Now
                </a>
            </div>
        </div>
    </div>
