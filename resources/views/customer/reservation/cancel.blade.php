...
<x-partials.page-hero
    ...
    subtitle="Your cancelled tour package reservations."
...
<section class="section-pad bg-cream-50">
    <div class="container-gd">
        <div class="grid gap-8 lg:grid-cols-3">
                ...
                <div class="space-y-6">
                    ...
                    @empty
                        <div class="card p-12 text-center">
                            ...
                            <p class="mt-2 text-sm text-ink-500">You have no cancelled bookings.</p>
                        </div>
                    @endforelse
                </div>
                @if (count($order) > 0)
            ...
            <div>
                <x-partials.reservation-sidebar :email="$isiemail" base="reservation" active="cancel" title="Status Booking" />
            </div>
        </div>
    </div>
</section>
