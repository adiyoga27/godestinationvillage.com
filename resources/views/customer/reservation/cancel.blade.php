        ...
        <div class="container">
            <div class="page-title-content">
                ...
                <ul>
                    ...
                    <li class="item"><a href="#"><i class='bx bx-chevrons-right'></i>Cancel </a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="content-list">
                                        ...
                                        <h6><span><a class="active" style="color: red"  href="{{ url('reservation-events/cancel/' . $email) }}">Cancel</span> </a></h6>
                                    </div>
                                </div>
                            </div>
                    </aside>
