    ...
    <div class="page-title-area ptb-100">
        <div class="container">
            <div class="page-title-content">
                <h1>Paid Reservation </h1>
                <ul>
                    <li class="item"><a href="index.html">Home</a></li>
                    <li class="item"><a href="#"><i class='bx bx-chevrons-right'></i>Reservation </a>
                    <li class="item"><a href="#"><i class='bx bx-chevrons-right'></i>Paid </a>
        ...
        <div class="bg-image">
            <img src="{{ url('assets/customer/img/page-title-area/privacy.jpg') }}" alt="Demo Image">
        </div>
    </div>
    <!-- end page title area -->
                                        ...
                                        <div class="col-md-8">
                                            <div class="content">
                                                <h3>
                                                    ...
                                                    <br>
                                                    <a href="destination-details.html">{{ $orders->package_name }}</a>
                                                </h3>
                                                <hr>
                                                ...
                                                <div class="row" style="font-size: 12pt; margin-top:5pt">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div style="margin-left: 20pt;">Rp {{ number_format($orders->total_payment) }}
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <strong>
                                                        ...
                                                        <div style="margin-left: 20pt;">{{ date('d M Y H:i', strtotime($orders->created_at)) }} </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="content-list">
                                        ...
                                        <h6><span><a class="active" style="color: red" href="{{ url('reservation/paid/' . $email) }}">Paid</a></span> </h6>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="content-list">
                                        <i class='bx bx-notepad'></i>
                                        <h6><span><a   href="{{ url('reservation-events/cancel/' . $email) }}">Cancel</span> </a></h6>
                                    </div>
                                </div>
                            </div>
                    </aside>
