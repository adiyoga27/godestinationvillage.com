...
<x-partials.page-hero
    title="PayPal Reservations"
    subtitle="Review reservations paid through PayPal."
    image="assets/customer/img/page-title-area/privacy.jpg"
    :crumbs="['Home' => '/', 'Reservation' => '', 'PayPal' => '']"
/>
                ...
                <div class="space-y-6">
                    ...
                    @empty
                        <div class="card p-12 text-center">
                            <p class="font-display text-xl font-bold text-ink-950">No PayPal transactions</p>
                            <p class="mt-2 text-sm text-ink-500">Your PayPal reservations will appear here.</p>
                        </div>
                    @endforelse
                </div>
                @if (count($order) > 0)
