...
<x-partials.page-hero
    ...
    :crumbs="['Home' => '/', 'Homestay' => '/homestay', 'Reservation' => '']"
/>
    ...
    <div class="container-gd max-w-4xl">
        <form action="{{ url('bookingHomeStay/sendHomeStay') }}" method="post" class="space-y-8">
            ...
            <div class="card p-8 sm:p-10">
                <h2 class="font-display text-xl font-bold text-ink-950">Homestay Information</h2>
                <div class="mt-6 grid gap-5 sm:grid-cols-2">
                    <div>
                        <span class="label-gd">Homestay Name</span>
