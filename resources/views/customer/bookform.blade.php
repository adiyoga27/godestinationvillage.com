...
<x-partials.page-hero
    ...
    subtitle="Complete your booking details for {{ $packages->name }}."
    image="assets/customer/img/page-title-area/account.jpg"
    :crumbs="['Home' => '/', 'Tour Packages' => '/tour-packages', 'Booking' => '']"
/>
...
<section class="section-pad bg-cream-50">
    <div class="container-gd max-w-4xl">
        <form action="{{ url('booking/send') }}" method="post" class="space-y-8">
            ...
            <div class="card p-8 sm:p-10">
                <h2 class="font-display text-xl font-bold text-ink-950">Booking Information</h2>
                <div class="mt-6 grid gap-5 sm:grid-cols-2">
                    <label class="block">
                    ...
                    <label class="block">
                        <span class="label-gd">Price / Pax @if ($packages->disc > 0)<span class="text-brand-600">(Discount)</span>@endif</span>
                        <div class="relative">
                    ...
                    @if ($packages->category->name != 'Virtual Tour')
                        ...
                        <label class="block sm:col-span-2">
                            ...
                            <span class="ml-2 text-sm font-semibold text-ink-700">Include Pickup Location?</span>
                        </label>
                        <label class="block hidden" id="dvPassport">
                            <span class="label-gd">Pick up location</span>
                            <input type="text" name="pickup" value=" " placeholder="Input your pick up location" class="input-gd" required>
                        </label>
                        <label class="block hidden" id="dvPassport2">
                            <span class="label-gd">Hotel / Villa / Guest House Name</span>
                            <input type="text" name="pickupname" value=" " placeholder="Input your place name" class="input-gd" required>
                        </label>
                    @endif
                    <label class="block sm:col-span-2">
