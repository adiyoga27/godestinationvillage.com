...
<x-partials.page-hero
    ...
    subtitle="{{ __('Your confirmed event reservations.') }}"
...
<section class="section-pad bg-cream-50">
    <div class="container-gd">
        <div class="grid gap-8 lg:grid-cols-3">
                ...
                <div class="space-y-6">
                    ...
                    @empty
                        <div class="card p-12 text-center">
                            ...
                            <p class="mt-2 text-sm text-ink-500">{{ __('You have no confirmed event bookings yet.') }}</p>
                        </div>
                    @endforelse
                </div>
                @if (count($order) > 0)
            ...
            <div>
                <x-partials.reservation-sidebar :email="$isiemail" base="reservation-events" active="paid" title="{{ __('Status Booking Events') }}" />
            </div>
        </div>
    </div>
</section>
