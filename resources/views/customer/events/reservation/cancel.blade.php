                            ...
                            <div class="col-md-12">
                                <div class="item-single mb-30">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="image">
                                                <img src="{{ url('storage/events/' . $orders->package->default_img) }}"
                                                    alt="Demo Image">
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="content">
                                                ...
                                                <div class="row" style="font-size: 12pt; margin-top:5pt">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div style="margin-left: 23pt;">{{ date('d M Y H:i', strtotime($orders->payment_date)) }} </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="content-list">
                                        ...
                                        <h6><span><a href="{{ url('reservation-events/' . $email) }}"
                                                > Unpaid </a></span> </h6>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="content-list">
                                        ...
                                        <h6><span><a href="{{ url('reservation-events/paid/' . $email) }}">Paid</a></span> </h6>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="content-list">
