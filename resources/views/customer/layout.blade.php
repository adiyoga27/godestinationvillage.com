    ...
    <div class="bg-ink-950 text-ink-200">
        <div class="container-gd flex items-center justify-between gap-4 py-2.5 text-[13px]">
            <div class="flex items-center gap-6">
                <a href="tel:{{ \App\Helpers\Site::get('phone', '+6281997674778') }}" class="flex items-center gap-2 hover:text-white transition">
                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
                    </svg>
                    {{ \App\Helpers\Site::get('phone_display', '+62 819-9767-4778') }}
                </a>
                <a href="mailto:{{ \App\Helpers\Site::get('email', 'hello@godestinationvillage.com') }}" class="hidden items-center gap-2 hover:text-white transition sm:flex">
                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                    </svg>
                    {{ \App\Helpers\Site::get('email', 'hello@godestinationvillage.com') }}
                </a>
            </div>
            <div class="flex items-center gap-3">
                ...
                <div class="hidden items-center gap-3 sm:flex">
                    <a href="{{ \App\Helpers\Site::get('facebook', 'https://www.facebook.com/godestinationvillage/') }}" target="_blank" rel="noopener" aria-label="Facebook"
                    ...
                    <a href="{{ \App\Helpers\Site::get('instagram', 'https://www.instagram.com/godestinationvillage/') }}" target="_blank" rel="noopener" aria-label="Instagram"
                        class="opacity-80 transition hover:opacity-100">
                    ...
                    <a href="{{ \App\Helpers\Site::get('youtube', 'https://www.youtube.com/channel/UCule1cMKmK4RKh_n-Rrx81A') }}" target="_blank" rel="noopener" aria-label="YouTube"
                        class="opacity-80 transition hover:opacity-100">
    ...
    <footer class="relative overflow-hidden bg-ink-950 text-ink-300">
        ...
        <div class="container-gd relative">
            ...
            <div class="flex flex-col items-start justify-between gap-6 border-b border-white/10 py-12 lg:flex-row lg:items-center">
                <div class="max-w-xl">
                    <h2 class="font-display text-2xl font-semibold text-white sm:text-3xl">{{ __('Discover authentic village experiences') }}</h2>
                ...
                <div class="col-span-2 lg:col-span-2">
                    ...
                    <div class="mt-5 max-w-sm" data-footer-about>
                        <p class="text-sm leading-relaxed text-ink-400">
                            {{ __('GODEVI adalah unit bisnis PT Banua Wisata Lestari yang bergerak di bidang riset dan konsultansi pengembangan desa serta destinasi pariwisata. Sejak 2018, telah mendampingi 50+ desa wisata di Bali dan Indonesia Timur.') }}
                        </p>
                        <a href="{{ route('about.godevi') }}"
                            class="mt-2 inline-flex items-center gap-1 text-sm font-bold text-brand-400 transition hover:gap-2 hover:text-brand-300">
                            {{ __('Selengkapnya') }}
                    ...
                    <div class="mt-6 flex items-center gap-3">
                        <a href="{{ \App\Helpers\Site::get('facebook', 'https://www.facebook.com/godestinationvillage/') }}" target="_blank" rel="noopener" aria-label="Facebook" class="flex h-10 w-10 items-center justify-center rounded-full border border-white/15 text-ink-200 transition hover:border-brand-600 hover:bg-brand-600 hover:text-white">
                            <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path d="M22 12.06C22 6.5 17.52 2 12 2S2 6.5 2 12.06c0 5 3.66 9.15 8.44 9.94v-7.03H7.9v-2.9h2.54V9.85c0-2.52 1.49-3.92 3.78-3.92 1.09 0 2.24.2 2.24.2v2.47h-1.26c-1.24 0-1.63.78-1.63 1.57v1.88h2.78l-.45 2.9h-2.33V22c4.78-.79 8.43-4.94 8.43-9.94z"/></svg>
                        </a>
                        <a href="{{ \App\Helpers\Site::get('instagram', 'https://www.instagram.com/godestinationvillage/') }}" target="_blank" rel="noopener" aria-label="Instagram" class="flex h-10 w-10 items-center justify-center rounded-full border border-white/15 text-ink-200 transition hover:border-brand-600 hover:bg-brand-600 hover:text-white">
                            <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.16c3.2 0 3.58.01 4.85.07 3.25.15 4.77 1.69 4.92 4.92.06 1.27.07 1.65.07 4.85s-.01 3.58-.07 4.85c-.15 3.23-1.66 4.77-4.92 4.92-1.27.06-1.64.07-4.85.07s-3.58-.01-4.85-.07c-3.26-.15-4.77-1.7-4.92-4.92-.06-1.27-.07-1.65-.07-4.85s.01-3.58.07-4.85C2.38 3.92 3.9 2.38 7.15 2.23 8.42 2.17 8.8 2.16 12 2.16zm0-2.16C8.74 0 8.33.01 7.05.07 2.7.27.27 2.69.07 7.05.01 8.33 0 8.74 0 12s.01 3.67.07 4.95c.2 4.36 2.62 6.78 6.98 6.98 1.28.06 1.69.07 4.95.07s3.67-.01 4.95-.07c4.35-.2 6.78-2.62 6.98-6.98.06-1.28.07-1.69.07-4.95s-.01-3.67-.07-4.95C23.73 2.7 21.31.28 16.95.07 15.67.01 15.26 0 12 0zm0 5.84A6.16 6.16 0 105.84 12 6.16 6.16 0 0012 5.84zm0 10.16a4 4 0 114-4 4 4 0 01-4 4zm6.4-11.85a1.44 1.44 0 11-1.44 1.44 1.44 1.44 0 011.44-1.44z"/></svg>
                        </a>
                        <a href="{{ \App\Helpers\Site::get('youtube', 'https://www.youtube.com/channel/UCule1cMKmK4RKh_n-Rrx81A') }}" target="_blank" rel="noopener" aria-label="YouTube" class="flex h-10 w-10 items-center justify-center rounded-full border border-white/15 text-ink-200 transition hover:border-brand-600 hover:bg-brand-600 hover:text-white">
                            <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path d="M23.5 6.19a3.02 3.02 0 00-2.12-2.14C19.5 3.55 12 3.55 12 3.55s-7.5 0-9.38.5A3.02 3.02 0 00.5 6.19C0 8.07 0 12 0 12s0 3.93.5 5.81a3.02 3.02 0 002.12 2.14c1.88.5 9.38.5 9.38.5s7.5 0 9.38-.5a3.02 3.02 0 002.12-2.14C24 15.93 24 12 24 12s0-3.93-.5-5.81zM9.55 15.57V8.43L15.82 12l-6.27 3.57z"/></svg>
                        </a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <ul class="mt-5 space-y-4 text-sm">
                        <li class="flex items-start gap-2.5">
                            ...
                            <span>{{ \App\Helpers\Site::get('address', 'Jl Kroya No 1, Denpasar, Bali') }}</span>
                        </li>
                        <li><a href="tel:{{ \App\Helpers\Site::get('phone', '+6281997674778') }}" class="flex items-center gap-2.5 transition hover:text-white">
                            <svg class="h-4 w-4 shrink-0 text-brand-500" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" /></svg>
                            {{ \App\Helpers\Site::get('phone_display', '+62 819-9767-4778') }}</a></li>
                        <li><a href="mailto:{{ \App\Helpers\Site::get('email', 'hello@godestinationvillage.com') }}" class="flex items-center gap-2.5 transition hover:text-white">
                            <svg class="h-4 w-4 shrink-0 text-brand-500" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" /></svg>
                            {{ \App\Helpers\Site::get('email', 'hello@godestinationvillage.com') }}</a></li>
                    </ul>
