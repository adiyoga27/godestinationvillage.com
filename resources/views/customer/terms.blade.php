...
<x-partials.page-hero
    ...
    subtitle="Please read these terms of use carefully before using GODEVI services."
    ...
    <div class="container-gd max-w-4xl">
        <div class="card p-8 sm:p-12">
            <div class="prose-gd text-sm leading-relaxed">
                <h2 class="font-display !text-2xl">1. Your Agreement</h2>
                ...
                <h2 class="font-display !text-2xl">2. Change of Terms of Use</h2>
                ...
                <h2 class="font-display !text-2xl">3. Access and Use of the Services</h2>
                ...
                <h2 class="font-display !text-2xl">4. Website and Content</h2>
                ...
                <h2 class="font-display !text-2xl">5. Intellectual Property Rights</h2>
                ...
                <h2 class="font-display !text-2xl">6. User Submissions</h2>
                ...
                <h2 class="font-display !text-2xl">7. Users Representations, Warranties and Undertakings</h2>
                ...
                <h2 class="font-display !text-2xl">8. Registration and Security</h2>
                ...
                <h2 class="font-display !text-2xl">9. Reviews — Further Correspondence — Rights to User Content</h2>
                ...
                <h2 class="font-display !text-2xl">10. Booking Confirmation, Tickets, Vouchers, Fees and Payment</h2>
                ...
                <h2 class="font-display !text-2xl">11. Discounts</h2>
                ...
                <h2 class="font-display !text-2xl">12. Godevi Referral Program</h2>
                ...
                <h2 class="font-display !text-2xl">13. Privacy Policy</h2>
                ...
                <h2 class="font-display !text-2xl">14. Indemnity</h2>
                ...
                <h2 class="font-display !text-2xl">15. Disclaimers and Limitation of Liability</h2>
                ...
                <h2 class="font-display !text-2xl">16. Interaction with Third Parties</h2>
                ...
                <h2 class="font-display !text-2xl">17. Payment</h2>
                ...
                <h2 class="font-display !text-2xl">18. Termination</h2>
                ...
                <h2 class="font-display !text-2xl">19. Passports, Visas & Insurances</h2>
                ...
                <h2 class="font-display !text-2xl">20. Governing Law</h2>
                ...
                <h2 class="font-display !text-2xl">21. Miscellaneous</h2>
                ...
                <h2 class="font-display !text-2xl">22. Contact</h2>
                ...
                <p class="!mt-8 text-xs font-semibold uppercase tracking-wider text-ink-400">Last updated on 18th Jun 2019.</p>
            </div>
        </div>
    </div>
</section>
