    ...
    <div class="container">
            ...
            <div class="col-lg-12">
                <div class="pull-right">
                    @if ($order->payment_status == 'pending')
                        ...
                        <button class="btn btn-lg btn-gradient-danger mb-2" onclick="printDiv('print');"><i
                                class="mdi mdi-printer"></i> Print Invoice</button>
                    @elseif($order->payment_status == 'success')

                        <button class="btn btn-lg btn-gradient-danger mb-2" onclick="printDiv('print');"><i
                                class="mdi mdi-printer"></i> Print Voucher</button>
        ...
        <div class="card" id="print">
            <div class="card-header">
                ...
                <span class="float-right"> <strong>Order Date :</strong>
                    {{ date('d M Y', strtotime($order->created_at)) }}</span>
            </div>
            <div class="card-body">
                <div class="row mb-4">
                    <div class="col-sm-12">
                        <span><strong>Arrival Date :</strong>
                            {{ date('d/m/Y', strtotime($order->checkin_date)) }}</span><br /><br /><br />
                    </div>
                    <div class="col-sm-6">
