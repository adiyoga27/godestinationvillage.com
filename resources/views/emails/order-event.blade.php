                    ...
                    <tr>
                        <td style="padding:40px;color:#1a1a26;font-size:15px;line-height:1.7;">
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-top:24px;border:1px solid #e8e4dc;border-radius:12px;overflow:hidden;">
                                ...
                                <tr>
                                    <td style="padding:12px 20px;font-weight:bold;font-size:13px;color:#14141f;border-top:1px solid #e8e4dc;">Event</td>
                                    <td style="padding:12px 20px;font-size:13px;color:#1a1a26;border-top:1px solid #e8e4dc;">{{ $order->event_name }}</td>
                                </tr>
                                <tr style="background-color:#f4f1ea;">
                                ...
                                <tr>
                                    <td style="padding:12px 20px;font-weight:bold;font-size:13px;color:#14141f;border-top:1px solid #e8e4dc;">Jumlah Peserta</td>
